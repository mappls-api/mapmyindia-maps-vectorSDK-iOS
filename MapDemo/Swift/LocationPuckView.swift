...
public class LocationPuckView: UIView {
    ...
    var puckView: LocationPuckStyleKitView!
    ...
    func commonInit() {
        puckView = LocationPuckStyleKitView(frame: bounds)
...
class LocationPuckStyleKitView: UIView {
